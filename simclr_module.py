...
class ResNetSimCLR(nn.Module):
    def __init__(self, input_channels=5, feat_dim=32, out_dim=16):
        
        super(ResNetSimCLR, self).__init__()

        self.backbone = ResNet(BasicBlock, [2, 2, 2, 2], feat_dim=feat_dim, num_classes=out_dim, input_channels=input_channels)
